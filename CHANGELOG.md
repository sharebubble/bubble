...
## [0.5.3](https://github.com/sharebubble/bubble/compare/v0.5.2...v0.5.3) (2026-09-13)
...
* **bookings:** add BookingAdmin overview with confirmed price and filters ([bc001fc](https://github.com/sharebubble/bubble/commit/bc001fce0d396c4530bb3573ee827f631c7f71d0))
* **bookings:** add BookingAdmin overview with confirmed price and filters ([3aa5f81](https://github.com/sharebubble/bubble/commit/3aa5f81fe4f059b894378fec9acd3426f8e3ce18))
...
* **calendar:** fetch bookings for the visible time range ([9b336a5](https://github.com/sharebubble/bubble/commit/9b336a5c7f040db00ebaa14083f25869b8444e31))
* **calendar:** fetch bookings for the visible time range ([d7a65a6](https://github.com/sharebubble/bubble/commit/d7a65a61ad79372d70aede09d103b733bea1c764))
* **calendar:** show bookers on past dates and default to free hours ([3a3f1a4](https://github.com/sharebubble/bubble/commit/3a3f1a47de468612c655c024b8155b2b1c21ee25))
* **favorites:** mark items as favorite and surface them ([c8c6a43](https://github.com/sharebubble/bubble/commit/c8c6a43c23c590406b534b0ac506d5939aed1e73))
* **favorites:** mark items as favorite and surface them ([61fc929](https://github.com/sharebubble/bubble/commit/61fc929771404a901246a800c3c78ab080711331))
* **home:** add load more and browse-all-items to the start page ([7d37d89](https://github.com/sharebubble/bubble/commit/7d37d8970ce9c74858ac520650f30baf0964e80c))
* **home:** compact favorites widget, load more, and browse-all button ([46b8cbf](https://github.com/sharebubble/bubble/commit/46b8cbfc83c3e0006ac20d8d9ca89bb169cbb0c0))
...
* **auth:** only treat a login-process error as an SSO return ([303ad9f](https://github.com/sharebubble/bubble/commit/303ad9f1ef1e147bb1e1671ac247f42b8775b6c8))
* **auth:** stop the SSO auto-login redirect loop ([3433fed](https://github.com/sharebubble/bubble/commit/3433fedc9452568e163709618cbe438c44d22588))
* **auth:** stop the SSO auto-login redirect loop ([ac926d6](https://github.com/sharebubble/bubble/commit/ac926d62e16eb244ba69a6e03cef775d366f5c31))
...
* **bookings:** auto-confirm self-service bookings when no rental price can be calculated ([8f63fe8](https://github.com/sharebubble/bubble/commit/8f63fe83dc0e861fd08d3cdd14d31124c5a0453f))
* **bookings:** auto-confirm self-service bookings when no rental price can be calculated ([04aebc4](https://github.com/sharebubble/bubble/commit/04aebc4e8a93b74fe8e6f0da5c55e2a64a9aa4ed))
* **bookings:** require a start time and surface open-ended rentals ([3679c7c](https://github.com/sharebubble/bubble/commit/3679c7c71d8f12029c4d8921f1fa8a9d64006d77))
* **bookings:** require a start time and surface open-ended rentals ([9148ba1](https://github.com/sharebubble/bubble/commit/9148ba151ca7532d0f2576826f8d0c608ed7e18b))
* **bookings:** return 400 instead of 500 when confirming overlapping booking ([286bc8d](https://github.com/sharebubble/bubble/commit/286bc8dd61aa5740ae61324c2393576e0b12b050))
* **bookings:** return 400 instead of 500 when confirming overlapping booking ([37ebff5](https://github.com/sharebubble/bubble/commit/37ebff5f4a3c26da726f1ddc9b8d9e41244ca6e8))
...
* **bookings:** use explicit None checks for confirmed price ([dd3229a](https://github.com/sharebubble/bubble/commit/dd3229a45ae5d23cd70301add84c969afc72deac))
...
* **home:** make favorites a compact sidebar widget ([f402a23](https://github.com/sharebubble/bubble/commit/f402a2373a3a83695d4d8474ad04d468a36e31d9))
